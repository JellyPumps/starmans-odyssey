...
public:
  ...
  Camera(float fov_deg = 60.0f, float aspect_ration = 16.0f / 9.0f,
  ...
  void set_perspective(float fov_deg, float aspect_ratio, float near_plane,
                       float far_plane);
  void set_orthographic(float size, float aspect_ratio, float near_plane,
                        float far_plane);
